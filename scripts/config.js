...
//runtime full：运行时版、完整版（是否带有compiler，运行时可用于脚手架搭建的单文件组件的语法，完整版可以直接传入模板）
//cjs esm：CommonJS、ESModule
//dev prod：开发、生产模式(生产模式压缩代码)
//browser：可以在浏览器中直接通过import语法引入的
            ...
            ts({
                ...
                tsconfigOverride: {
                    compilerOptions: {
                        ...
                        target: opts.transpile === false || opts.format === 'cjs' ?
                            'es2017' : 'es5'
                    },
